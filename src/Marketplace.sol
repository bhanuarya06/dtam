...
contract Marketplace {
    ...
    function listItem(string memory _name, uint _price, string memory _category) public {
        require(_price > 0, "Price must be greater than zero");

        itemCount++;
        items[itemCount] = Item(itemCount, _name, _price, _category, payable(msg.sender), msg.sender, false);
...
//0x2d4fb1969768a2268693336cbc6ad0c6c5992aa5
//0x7f574f71d2840d2ec7ac0006600c37c7559c12d2
//0xddf2e103f5345cbc3c7907971409262c57dca8b7